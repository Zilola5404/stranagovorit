...
class Skin_Cards extends Skin_Base {
	...
	public function register_additional_design_image_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-post__card .elementor-post__badge' => 'margin: {{SIZE}}{{UNIT}} 15px',
				],
				'condition' => [
					$this->get_control_id( 'show_badge' ) => 'yes',
				],
	...
	protected function render_badge() {
		...
		?>
		<div class="elementor-post__badge" style="margin: 10px; opacity: 0.85;background-color: #0074bc;font-size: 14px;"><?php do_action( 'echo_subsers' ); ?></div>
		<div class="elementor-post__blabel"><?php do_action( 'echo_blabel' ); ?></div>

		<style>
			.elementor-post__blabel{
				position: absolute;
				top: 0;
				left: 0;
			}
