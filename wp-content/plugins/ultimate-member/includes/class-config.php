		...
		function __construct() {
			...
			$this->email_notifications = apply_filters( 'um_email_notifications', array(
				'welcome_email' => array(
					...
					'body'          => 'Здравствуйте, {display_name},<br /><br />' .
					                   'Спасибо, что подписались на {site_name}! Ваша учетная запись активна.<br /><br />' .
					                   'Для входа перейдите по следующему адресу:<br /><br />' .
					                   '{login_url} <br /><br />' .
					                   'Электронная почта вашей учетной записи: {email} <br />' .
					                   'Имя пользователя вашей учетной записи: {username} <br /><br />' .
					                   'Если у вас возникли проблемы, пожалуйста, свяжитесь с нами по адресу {admin_email}<br /><br />' .
					                   'Спасибо,<br />' .
					                   '{site_name}',
					'description'   => __('Отправлять ли пользователю электронное письмо, когда его учетная запись автоматически утверждается','ultimate-member'),
					'recipient'   => 'user',
					'default_active' => true
				),
				'checkmail_email' => array(
					'key'           => 'checkmail_email',
					'title'         => __( 'Электронная почта для активации учетной записи','ultimate-member' ),
					'subject'       => 'Пожалуйста, активируйте свою учетную запись',
					'body'          => 'Здравствуйте, {display_name},<br /><br />' .
					                   'Спасибо, что подписались на {site_name}! Чтобы активировать свою учетную запись, нажмите на ссылку ниже, чтобы подтвердить свой адрес электронной почты.:<br /><br />' .
					                   '{account_activation_link} <br /><br />' .
					                   'Если у вас возникли проблемы, пожалуйста, свяжитесь с нами по адресу {admin_email}<br /><br />' .
					                   'Спасибо, <br />' .
					                   '{site_name}',
					'description'   => __('Отправлять ли пользователю электронное письмо, когда его учетной записи требуется активация по электронной почте','ultimate-member'),
					'recipient'   => 'user'
				),
				'pending_email' => array(
					'key'           => 'pending_email',
					'title'         => __( 'Ваш аккаунт ожидает проверки','ultimate-member' ),
					'subject'       => '[{site_name}] Новая учетная запись пользователя',
					'body'          => 'Здравствуйте, {display_name}, <br /><br />' .
					                   'Спасибо, что подписались на {site_name}! Ваша учетная запись в настоящее время проверяется членом нашей команды.<br /><br />' .
					                   'Пожалуйста, дайте нам некоторое время, чтобы обработать ваш запрос.<br /><br />' .
					                   'Если у вас возникли проблемы, пожалуйста, свяжитесь с нами по адресу {admin_email}<br /><br />' .
					                   'Спасибо,<br />' .
					                   '{site_name}',
					'description'   => __('Отправлять ли пользователю электронное письмо, когда его учетная запись нуждается в проверке администратором','ultimate-member'),
					'recipient'   => 'user'
				),
				'approved_email' => array(
					'key'           => 'approved_email',
					'title'         => __( 'Электронная почта, одобренная учетной записью','ultimate-member' ),
					'subject'       => 'Ваш аккаунт на {site_name} теперь активен',
					'body'          => 'Здравствуйте {display_name},<br /><br />' .
					                   'Спасибо, что подписались на {site_name}! Ваш аккаунт одобрен и теперь активен.<br /><br />' .
					                   'Для входа перейдите по следующему адресу:<br /><br />' .
					                   '{login_url}<br /><br />' .
					                   ...
					                   'Спасибо,<br />' .
					                   '{site_name}',
					'description'   => __('Отправлять ли пользователю электронное письмо, когда его учетная запись одобрена','ultimate-member'),
					'recipient'   => 'user'
				),
				'rejected_email' => array(
					'key'           => 'rejected_email',
					'title'         => __( 'Электронная почта с отклоненным аккаунтом','ultimate-member' ),
					'subject'       => 'Ваш аккаунт был отклонен',
					'body'          => 'Здравствуйте {display_name},<br /><br />' .
				...
				'changedaccount_email' => array(
					...
					'subject'       => 'Ваш аккаунт на {site_name} was updated',
					'body'          => 'Здравствуйте {display_name},<br /><br />' .
