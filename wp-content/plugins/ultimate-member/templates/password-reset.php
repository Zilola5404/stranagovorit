				...
				<div class="um-field um-field-block um-field-type_block">
					<div class="um-field-block">
						<div style="text-align:center;">
							<?php esc_html_e( 'Если учетная запись, соответствующая предоставленным данным, существует, мы вышлем ссылку для сброса пароля. Пожалуйста, проверьте свой почтовый ящик.', 'ultimate-member' ); ?>
						</div>
					</div>
				</div>
			<?php } else { ?>
