...
<div style="padding: 30px 0;font-size: 24px;text-align: center;line-height: 40px">Спасибо за регистрацию!</div>
...
<div style="padding: 20px">>Нужна помощь?<a style="color: #3ba1da;text-decoration: none" href="mailto:{admin_email}">Напишите нам</a></div>
</div>
