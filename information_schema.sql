...
--
-- Хост: localhost
-- Время создания: Ноя 11 2022 г., 12:13
-- Версия сервера: 8.0.31-0ubuntu0.22.04.1
-- Версия PHP: 8.1.2-1ubuntu2.8
...
--
-- Дублирующая структура для представления `ADMINISTRABLE_ROLE_AUTHORIZATIONS`
...
--
-- Дублирующая структура для представления `APPLICABLE_ROLES`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `CHARACTER_SETS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `CHECK_CONSTRAINTS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `COLLATIONS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `COLLATION_CHARACTER_SET_APPLICABILITY`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `COLUMNS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `COLUMNS_EXTENSIONS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `COLUMN_PRIVILEGES`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `COLUMN_STATISTICS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `ENABLED_ROLES`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `ENGINES`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `EVENTS`
-- (См. Ниже фактическое представление)
--
CREATE TABLE `EVENTS` (
...
--
-- Дублирующая структура для представления `FILES`
-- (См. Ниже фактическое представление)
--
CREATE TABLE `FILES` (
...
--
-- Дублирующая структура для представления `INNODB_BUFFER_PAGE`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_BUFFER_PAGE_LRU`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_BUFFER_POOL_STATS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_CACHED_INDEXES`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_CMP`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_CMPMEM`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_CMPMEM_RESET`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_CMP_PER_INDEX`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_CMP_PER_INDEX_RESET`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_CMP_RESET`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_COLUMNS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_DATAFILES`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_FIELDS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_FOREIGN`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_FOREIGN_COLS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_FT_BEING_DELETED`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_FT_CONFIG`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_FT_DEFAULT_STOPWORD`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_FT_DELETED`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_FT_INDEX_CACHE`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_FT_INDEX_TABLE`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_INDEXES`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_METRICS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_SESSION_TEMP_TABLESPACES`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_TABLES`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_TABLESPACES`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_TABLESPACES_BRIEF`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_TABLESTATS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_TEMP_TABLE_INFO`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_TRX`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `INNODB_VIRTUAL`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `KEYWORDS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `KEY_COLUMN_USAGE`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `OPTIMIZER_TRACE`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `PARAMETERS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `PARTITIONS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `PLUGINS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `PROFILING`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `REFERENTIAL_CONSTRAINTS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `RESOURCE_GROUPS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `ROLE_COLUMN_GRANTS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `ROLE_ROUTINE_GRANTS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `ROLE_TABLE_GRANTS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `ROUTINES`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `SCHEMATA`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `SCHEMATA_EXTENSIONS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `SCHEMA_PRIVILEGES`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `STATISTICS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `ST_GEOMETRY_COLUMNS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `ST_SPATIAL_REFERENCE_SYSTEMS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `ST_UNITS_OF_MEASURE`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `TABLES`
-- (См. Ниже фактическое представление)
--
CREATE TABLE `TABLES` (
...
--
-- Дублирующая структура для представления `TABLESPACES`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `TABLESPACES_EXTENSIONS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `TABLES_EXTENSIONS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `TABLE_CONSTRAINTS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `TABLE_CONSTRAINTS_EXTENSIONS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `TABLE_PRIVILEGES`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `TRIGGERS`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `USER_ATTRIBUTES`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `USER_PRIVILEGES`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `VIEWS`
-- (См. Ниже фактическое представление)
--
CREATE TABLE `VIEWS` (
`CHARACTER_SET_CLIENT` varchar(64)
...
--
-- Дублирующая структура для представления `VIEW_ROUTINE_USAGE`
-- (См. Ниже фактическое представление)
--
...
--
-- Дублирующая структура для представления `VIEW_TABLE_USAGE`
-- (См. Ниже фактическое представление)
--
...
--
-- Структура для представления `ADMINISTRABLE_ROLE_AUTHORIZATIONS`
--
...
--
-- Структура для представления `APPLICABLE_ROLES`
--
...
--
-- Структура для представления `CHARACTER_SETS`
--
...
--
-- Структура для представления `CHECK_CONSTRAINTS`
--
...
--
-- Структура для представления `COLLATIONS`
--
...
--
-- Структура для представления `COLLATION_CHARACTER_SET_APPLICABILITY`
--
...
--
-- Структура для представления `COLUMNS`
--
...
--
-- Структура для представления `COLUMNS_EXTENSIONS`
--
...
--
-- Структура для представления `COLUMN_PRIVILEGES`
--
...
--
-- Структура для представления `COLUMN_STATISTICS`
--
...
--
-- Структура для представления `ENABLED_ROLES`
--
...
--
-- Структура для представления `ENGINES`
--
...
--
-- Структура для представления `EVENTS`
--
...
--
-- Структура для представления `FILES`
--
DROP TABLE IF EXISTS `FILES`;
-- Структура чтения ошибок для таблицы information_schema.FILES: #1227 - В доступе отказано. Вам нужны привилегии PROCESS для этой операции

-- --------------------------------------------------------

--
-- Структура для представления `INNODB_BUFFER_PAGE`
--
...
--
-- Структура для представления `INNODB_BUFFER_PAGE_LRU`
--
...
--
-- Структура для представления `INNODB_BUFFER_POOL_STATS`
--
...
--
-- Структура для представления `INNODB_CACHED_INDEXES`
--
...
--
-- Структура для представления `INNODB_CMP`
--
...
--
-- Структура для представления `INNODB_CMPMEM`
--
...
--
-- Структура для представления `INNODB_CMPMEM_RESET`
--
...
--
-- Структура для представления `INNODB_CMP_PER_INDEX`
--
...
--
-- Структура для представления `INNODB_CMP_PER_INDEX_RESET`
--
...
--
-- Структура для представления `INNODB_CMP_RESET`
--
...
--
-- Структура для представления `INNODB_COLUMNS`
--
...
--
-- Структура для представления `INNODB_DATAFILES`
--
...
--
-- Структура для представления `INNODB_FIELDS`
--
...
--
-- Структура для представления `INNODB_FOREIGN`
--
...
--
-- Структура для представления `INNODB_FOREIGN_COLS`
--
...
--
-- Структура для представления `INNODB_FT_BEING_DELETED`
--
...
--
-- Структура для представления `INNODB_FT_CONFIG`
--
...
--
-- Структура для представления `INNODB_FT_DEFAULT_STOPWORD`
--
...
--
-- Структура для представления `INNODB_FT_DELETED`
--
...
--
-- Структура для представления `INNODB_FT_INDEX_CACHE`
--
...
--
-- Структура для представления `INNODB_FT_INDEX_TABLE`
--
...
--
-- Структура для представления `INNODB_INDEXES`
--
...
--
-- Структура для представления `INNODB_METRICS`
--
...
--
-- Структура для представления `INNODB_SESSION_TEMP_TABLESPACES`
--
...
--
-- Структура для представления `INNODB_TABLES`
--
...
--
-- Структура для представления `INNODB_TABLESPACES`
--
...
--
-- Структура для представления `INNODB_TABLESPACES_BRIEF`
--
...
--
-- Структура для представления `INNODB_TABLESTATS`
--
...
--
-- Структура для представления `INNODB_TEMP_TABLE_INFO`
--
...
--
-- Структура для представления `INNODB_TRX`
--
...
--
-- Структура для представления `INNODB_VIRTUAL`
--
...
--
-- Структура для представления `KEYWORDS`
--
...
--
-- Структура для представления `KEY_COLUMN_USAGE`
--
...
--
-- Структура для представления `OPTIMIZER_TRACE`
--
...
--
-- Структура для представления `PARAMETERS`
--
...
--
-- Структура для представления `PARTITIONS`
--
...
--
-- Структура для представления `PLUGINS`
--
...
--
-- Структура для представления `PROFILING`
--
...
--
-- Структура для представления `REFERENTIAL_CONSTRAINTS`
--
...
--
-- Структура для представления `RESOURCE_GROUPS`
--
...
--
-- Структура для представления `ROLE_COLUMN_GRANTS`
--
...
--
-- Структура для представления `ROLE_ROUTINE_GRANTS`
--
...
--
-- Структура для представления `ROLE_TABLE_GRANTS`
--
...
--
-- Структура для представления `ROUTINES`
--
...
--
-- Структура для представления `SCHEMATA`
--
...
--
-- Структура для представления `SCHEMATA_EXTENSIONS`
--
...
--
-- Структура для представления `SCHEMA_PRIVILEGES`
--
...
--
-- Структура для представления `STATISTICS`
--
...
--
-- Структура для представления `ST_GEOMETRY_COLUMNS`
--
...
--
-- Структура для представления `ST_SPATIAL_REFERENCE_SYSTEMS`
--
...
--
-- Структура для представления `ST_UNITS_OF_MEASURE`
--
...
--
-- Структура для представления `TABLES`
--
...
--
-- Структура для представления `TABLESPACES`
--
...
--
-- Структура для представления `TABLESPACES_EXTENSIONS`
--
...
--
-- Структура для представления `TABLES_EXTENSIONS`
--
...
--
-- Структура для представления `TABLE_CONSTRAINTS`
--
...
--
-- Структура для представления `TABLE_CONSTRAINTS_EXTENSIONS`
--
...
--
-- Структура для представления `TABLE_PRIVILEGES`
--
...
--
-- Структура для представления `TRIGGERS`
--
...
--
-- Структура для представления `USER_ATTRIBUTES`
--
...
--
-- Структура для представления `USER_PRIVILEGES`
--
...
--
-- Структура для представления `VIEWS`
--
...
--
-- Структура для представления `VIEW_ROUTINE_USAGE`
--
...
--
-- Структура для представления `VIEW_TABLE_USAGE`
--
